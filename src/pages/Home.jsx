...
function Home() {
  ...
  const scroll = () => {
    resultHeadRef.current.scrollIntoView({ behavior: "smooth" });
  };
  ...
  return (
    <div>
      <div className={styles.background}>
        ...
        <div className={styles.searchContainer}>
          <div className={styles.search}>
            ...
            />
            <button onClick={handleSearchDish} className={styles.searchBtn}>
              Search
            </button>
      ...
      {results.length > 0 && (
        <div>
          <h1 ref={resultHeadRef} className={styles.resultHead}>
            {resultHead}
          </h1>
          ...
          {categories.length > 0 &&
            categories.map((category, i) => {
              return (
                <div
                  onClick={() => {
                    redirect(`/category/${category.strCategory}`);
                  }}
                  key={i}
                >
